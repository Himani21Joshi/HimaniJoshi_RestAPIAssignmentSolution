...
<body>
	...
	<div class="container">
		...
		<form action="/Employee_Management/books/search" class="form-inline">

				<!-- Add a button -->
				<a href="/Employee_Management/books/showFormForAdd"
				...
				<button type="submit" class="btn btn-success btn-sm mb-3">Search</button>
					<a href="/Employee_Management/logout" 
				...
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						...
						<td>
							...
							href="/Employee_Management/books/showFormForUpdate?bookId=${tempBook.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/Employee_Management/books/delete?bookId=${tempBook.id}"
